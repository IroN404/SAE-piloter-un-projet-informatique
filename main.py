...
import sys
import sqlite3
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QMessageBox, QDesktopWidget, QGridLayout, QLabel, \
    QLineEdit, QFormLayout, QComboBox, QTableWidget, QTableWidgetItem, QFrame, QVBoxLayout, QHBoxLayout, QGroupBox, \
    QScrollArea, QSizePolicy, QSpacerItem, QStyle, QStyleOption, QFileDialog, QDialog, QDateEdit, QCheckBox, \
    QProgressBar, QSlider, QDial, QCalendarWidget, QTabWidget, QTabBar, QStackedWidget, QToolButton, QMenu, QMenuBar, \
    QStatusBar, QToolBar, QDockWidget, QStyleFactory, QSystemTrayIcon, QCompleter, QShortcut, QKeySequenceEdit, \
    QSplitter, QInputDialog, QCommandLinkButton, QAbstractItemView, QHeaderView, QStyleOptionViewItem, QStyleOptionTab, \
    QStylePainter, QStyleOptionTabBarBase
...
""")
        ...
        self.taskTable.setHorizontalHeaderLabels(
            ["id", "Task Name", "Priority", "Person", "Status", "Time Left", "Progress", "Actions"])
...
class HomeInterface(QFrame):
    def __init__(self, text: str, parent=None):
        ...
        descriptionLabel = CaptionLabel(
            'Vous pouvez aussi voir les tâches de vos collaborateurs et les modifier si besoin.', self)
...
class Window(FluentWindow):
    ...
    def initNavigation(self):
        ...
        self.navigationInterface.addWidget(
            routeKey='avatar',
            widget=NavigationAvatarWidget('Toto', 'media/user-icon.png'),
