import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QWidget, QVBoxLayout, QDateTimeEdit, QLabel
...
class ModeJourNuitApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Ajout de la DateSelectionWidget à la fenêtre principale
        self.date_selection_widget = DateSelectionWidget()
        self.main_layout.addWidget(self.date_selection_widget)
...
# Classe pour la sélection de date et heure
